...
if __name__ == "__main__":
    ...
    f = read(f"binary64-52-{backend}")
    assert(len(f) == 1)
    s = f['0x1.4000000000000p+0']
    assert(f['0x1.4000000000001p+0'] == its)

    f = read(f"binary64-53-{backend}")
    assert(len(f) == 2)
    s = f['0x1.4000000000000p+0']
    assert(binomial_test_ci(s, its, 0.5))

    f = read(f"binary64-54-{backend}")
    assert(len(f) == 2)
    s = f['0x1.4000000000000p+0']
    assert(binomial_test_ci(s, its, 0.75))

    f = read(f"binary64-55-{backend}")
    assert(len(f) == 2)
    s = f['0x1.4000000000000p+0']
    assert(binomial_test_ci(s, its, 0.875))