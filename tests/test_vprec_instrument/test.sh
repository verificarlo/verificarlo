...
for i in 1 26 52; do
	echo \
"test.c/powf_64_27	1	0	1	0	$i	11	23	8	2	1	1
input:	0	23	8
input:	0	23	8
output:	0	23	8
test.c/Fdouble_84_47	0	0	0	1	$i	11	23	8	2	1	1
input:	1	$i	11
input:	1	$i	11
output:	1	$i	11
test.c/Ffloat_85_49	0	0	1	0	$i	11	23	8	2	1	1
input:	0	23	8
input:	0	23	8
output:	0	23	8
test.c/pow_47_10	1	0	0	1	$i	11	23	8	2	1	1
input:	1	$i	11
input:	1	$i	11
...
for i in 1 11 23; do
	echo \
"test.c/powf_64_27	1	0	1	0	52	11	$i	8	2	1	1
input:	0	$i	8
input:	0	$i	8
output:	0	$i	8
test.c/Fdouble_84_47	0	0	0	1	52	11	$i	8	2	1	1
input:	1	52	11
input:	1	52	11
output:	1	52	11
test.c/Ffloat_85_49	0	0	1	0	52	11	$i	8	2	1	1
input:	0	$i	8
input:	0	$i	8
output:	0	$i	8
test.c/pow_47_10	1	0	0	1	52	11	$i	8	2	1	1
input:	1	52	11
input:	1	52	11
