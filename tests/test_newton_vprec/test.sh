...
VFC_BACKENDS="libinterflop_ieee.so" ./newton 0 15 > ieee.out || true
...
VFC_SCHEDULE_FILE=schedule_1e-5.txt ./newton 1 5 > vprec_1e-5.out || true
...
VFC_SCHEDULE_FILE=schedule_1e-10.txt ./newton 1 10 > vprec_1e-10.out || true
...
VFC_SCHEDULE_FILE=schedule_1e-15.txt ./newton 1 15 > vprec_1e-15.out || true
