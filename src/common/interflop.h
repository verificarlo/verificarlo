...
struct interflop_backend_interface_t {
  ...
  void (*interflop_cmp_float_vector)(enum FCMP_PREDICATE p, int size, float *a, float *b, int *c,
				     void *context);
  ...
  void (*interflop_cmp_double_vector)(enum FCMP_PREDICATE p, int size, double *a, double *b, int *c,
				      void *context);
